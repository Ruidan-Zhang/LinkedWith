...
import { createSkillThunk } from "../../../../store/profile";
...
function CreateSkillForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        await dispatch(createSkillThunk(currentUser.id, newSkill));
    ...
    return (
        <form onSubmit={handleSubmit} className='create-experience-form-main-container'>
            <h2 className="create-experience-form-title">Add Skill</h2>
