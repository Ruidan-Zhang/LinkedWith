...
import { deleteEducationThunk } from '../../../../store/profile';
import { getUserProfileThunk } from '../../../../store/users';

const DeleteEducationConfirmation = ({ education }) => {
    ...
    const deleteHandler = async (e) => {
        e.preventDefault();
        await dispatch(deleteEducationThunk(currentUser.id, education.id));
        closeModal();
    ...
    return (
        <div className='delete-post-confirmation-container'>
            <h2 className='delete-post-title'>Delete education?</h2>
            <h5 className='delete-post-body'>Are you sure you want to permanently remove this education?</h5>
...
export default DeleteEducationConfirmation;
